...
def _redirect_view_code_received(request):
    ...
    request_params['redirect_uri'] = config.Config.redirect_uri
    request_params['grant_type'] = 'authorization_code'
    request_params['client_secret'] = config.Config.client_secrect
    request_params['client_id'] = config.Config.client_id
    ...
    if 'access_token' in resp_object:
        ...
        templ = get_template('redirect_success.html')
